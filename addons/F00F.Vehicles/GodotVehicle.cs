...
{
    [Tool]
    public partial class GodotVehicle : VehicleBody3D, IActive, ITarget
    {
        private bool _active;
        public bool Active { get => _active; set => this.Set(ref _active, value, ActiveSet); }
        public event Action ActiveSet;

        private GodotVehicleData _config;
        [Export] public GodotVehicleData Config { get => _config; set => this.Set(ref _config, value ?? new(), () => Config.Init(this)); }
