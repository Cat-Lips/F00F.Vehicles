...
public partial class RigidBodyVehicle
{
    private static class Default
    {
        ...
        public const GlbShapeType WheelShape = GlbShapeType.Convex;
        ...
        public static readonly GlbShapeType[] AllowedWheelShapes = [GlbShapeType.None, GlbShapeType.Convex, GlbShapeType.CylinderX];
    }

    private readonly List<RigidBody3D> wheels = [];
    private RigidBody3D[] rearWheels, frontWheels, driveWheels, steerWheels;
    ...
    private void OnModelSet()
    {
        ...
        {
            if (Model.IsWheel(part) && part is RigidBody3D wheel)
                wheels.Add(wheel);
        }
    }
